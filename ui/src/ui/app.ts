...
import {
  ...
  handleSignalLink as handleSignalLinkInternal,
...
export class ClawdbotApp extends LitElement {
  ...
  @state() replyToMessage: unknown | null = null;
  // Sidebar state for tool output viewing
  @state() sidebarOpen = false;
  @state() sidebarContent: string | null = null;
  @state() sidebarMode: "view" | "edit" = "view";
  ...
  @state() signalQrDataUrl: string | null = null;
  @state() signalLinkMessage: string | null = null;
  @state() signalLinkBusy = false;
  ...
  @state() llmDebugHistory: import("./controllers/llm-debug").LlmInteraction[] =
    [];
  @state() llmTraceModalStep: unknown | null = null;
  @state() llmTraceModalTurnId: string | null = null;
  ...
  async handleSignalLink() {
    await handleSignalLinkInternal(this);
  }
  ...
  handleOpenSidebar(content: string, mode: "view" | "edit" = "view") {
  ...
  handleSelectReplyTo(message: unknown | null) {
